...
function buildMessage(
  ...
  return `Hi ${firstName}, we're very sorry for the inconvenience caused by the cancellation of your appointment with ${coupon.stylistName || "your stylist"} at AK Hair & Beauty Salon.
