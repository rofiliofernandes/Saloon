              ...
              <div>
                ...
                <div className="relative mt-2">
                  <input
                    ...
                    minLength={8}
                    className="w-full rounded-xl border px-4 py-3 pr-12 text-sm outline-none focus:border-neutral-900"
                    required
                  />
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-neutral-400 transition hover:bg-neutral-100 hover:text-neutral-900"
                    aria-label={
                      showPassword
                        ? "Hide password"
                        : "Show password"
