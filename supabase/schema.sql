-- REFERENCE BASELINE ONLY: production deployments should use the ordered files in supabase/migrations. This file is not the authoritative production schema.
...
create table public.coupon_outreach_history (
  id uuid primary key default gen_random_uuid(),
